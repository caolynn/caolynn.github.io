(function () {
    ...
    class Gyroscope_Sample extends ui.MainUI {
        constructor() {
            super();
        ...
        onDeviceorientation(absolute, rotationInfo) {
            ...
            console.log(this.test_test.text);
        }
    }
    ...
    class GameConfig {
        ...
        static init() {
            var reg = Laya.ClassUtils.regClass;
            reg("script/Gyroscope_Sample.ts", Gyroscope_Sample);
    ...
    class Main {
        constructor() {
            ...
            Laya.ResourceVersion.enable("version-95e100e0b0.json", Laya.Handler.create(this, this.onVersionLoaded), Laya.ResourceVersion.FILENAME_VERSION);
        }
        onVersionLoaded() {
